...
class StanModelGenerator:
    ...
    def __catch_input_error_carryover_transfo_nm(self, carryover_transfo_nm):

        if carryover_transfo_nm not in ["adstock", "geo_decay"]:
            raise ValueError("carryover_transfo_nm must be 'adstock' or 'geo_decay'")

    def __catch_input_error_diminushing_returns_transfo_nm(self, diminushing_returns_transfo_nm):
    ...
    def __create_functions_code(self):

        self.__function_code = "functions {\n %s %s\n}"
        
        carryover_code = self.__create_carryover_code()
        diminushing_returns_code = self.__create_diminushing_returns_code()
    ...
    def __create_diminushing_returns_code(self):
    ...
    def __create_carryover_code(self):
    ...
    def __create_parameters_code(self):
        ...
        carryover_parameters = self.__create_carryover_parameters()
        ctrl_vars_parameters = self.__create_ctrl_vars_parameters()
        diminushing_returns_parameters = self.__create_diminushing_returns_parameters()

        self.__parameters_code = self.__parameters_code % (
            carryover_parameters, ctrl_vars_parameters, diminushing_returns_parameters
        )

    def __create_carryover_parameters(self):
    ...
    def __create_ctrl_vars_parameters(self):
    ...
    def __create_diminushing_returns_parameters(self):
    ...
    def __create_transformed_parameters_code(self):
        ...
        carryover_call = self.__create_carryover_call()
        diminushing_returns_call = self.__create_diminushing_returns_call()
    ...
    def __create_carryover_call(self):
    ...
    def __create_diminushing_returns_call(self):
    ...
    def __create_model_code(self):
        ...
        carryover_prior = self.__create_carryover_prior()
        diminushing_returns_prior = self.__create_diminushing_returns_prior()
        ctrl_coef_prior = self.__create_ctrl_coef_prior()
    ...
    def __create_carryover_prior(self):
    ...
    def __create_diminushing_returns_prior(self):
    ...
    def __create_ctrl_coef_prior(self):
    ...
    # def get_parameters_estimation(self, sampled_parameters: array, estimator_nm: str):
    #     pass
